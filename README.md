...
### Word Cloud
![Word Cloud](screenshots/example_wordcloud.png)

---
## 🚀 Features

* **Automated Fetching:** Retrieves thousands of comments using YouTube API pagination to avoid recency biases
* **Sentiment Engine:** Classifies comments as Positive, Neutral, or Negative using VADER
...
5.  **Run the analysis:**
    ...
    * Run the script:
        ...
        python mood_ring.py
        ```
     * **Tip:** Don't have an API key? You can check the ([comments_from_video_for_testing.csv](./comments_from_video_for_testing.csv)) file included in this repo to see what the raw data looks like!
